...
function Hero() {
  ...
  return (
    <div
      id="header"
      ref={ref}
      class={inView ? "section-header motion-safe:animate-fadeIn" : "invisible"}
    >
      <div className="text-title-responsive">{inView.toString()} </div>
  ...
  return (
    <div class="bg-nearBlack text-white">
      <div
        id="about"
        ref={ref}
        class={inView ? "section motion-safe:animate-fadeIn" : "invisible"}
      >
    ...
    <div class="bg-nearBlack text-white">
      ...
      >
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div ref={ref} class={"text-4xl mt-4 xl:mt-10 pb-6"}>
              Education
            </div>
            <ExperienceCard
